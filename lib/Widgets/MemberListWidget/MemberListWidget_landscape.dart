...
class MemberGridListWidget_landscape extends StatefulWidget {

  dynamic height;
  dynamic width;
  GlobalKey<ScaffoldState> scaffoldKey;

  MemberGridListWidget_landscape({this.height, this.width, this.scaffoldKey});

  @override
  _MemberGridListWidget_landscapeState createState() => _MemberGridListWidget_landscapeState();
}

class _MemberGridListWidget_landscapeState extends State<MemberGridListWidget_landscape> {
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                Padding(
                                  padding: EdgeInsets.only(right: wp(3),top: hp(1),bottom: hp(1)),
                                  child: new Container(
                                      width: wp(15),
                                      height: hp(10),
