...
class MainContainer_register extends StatefulWidget {
  dynamic height;
  dynamic width;
  GlobalKey<ScaffoldState> scaffoldKey;

  MainContainer_register({this.height, this.width, this.scaffoldKey});

  @override
  _MainContainer_registerState createState() => _MainContainer_registerState();
}

class _MainContainer_registerState extends State<MainContainer_register> {
