...
class MainContainer_landscape extends StatefulWidget {
  dynamic height;
  dynamic width;
  GlobalKey<ScaffoldState> scaffoldKey;

  MainContainer_landscape({this.height, this.width, this.scaffoldKey});

  @override
  _MainContainer_landscapeState createState() => _MainContainer_landscapeState();
}

class _MainContainer_landscapeState extends State<MainContainer_landscape> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(
          top: hp(20), left: wp(5), right: wp(5), bottom: hp(10)),
